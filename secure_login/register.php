<!-- Neste arquivo php estava com alguns erros, mas já foram solucionados. -->
...
<body>
    <!-- Registration form to be output if the POST variables are not set of if the registration script caused an error. -->
